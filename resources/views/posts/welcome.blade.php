    ...
    @auth
        ...
        @if (Auth::user()->usertype == 'admin2' or Auth::user()->usertype == 'admin')
            <a href="{{ route('Control.create') }}"
                class=" px-8 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                اضافة منشور</a>
                ...
                @if ($sec->id == $post->idsection)
                    <div class="border-b mb-5 flex justify-between text-sm my-10">
                        <div class="text-bro flex items-center pb-2 pr-2 border-b-2 border-bro uppercase">
                            ...
                            <a href="{{ Route('posts.show_all', $sec->id) }}"
                                class="font-semibold inline-block">{{ $sec->section_Name }}</a>
                        </div>
                            ...
                            <div class="rounded overflow-hidden shadow-lg flex flex-col">
                                ...
                                <div class="relative">
                                    <a href="{{ Route('posts.show', $post->id) }}">
                                        <img class="w-full h-40 border border-t-bro"
                                            src="{{ ($post->imgart != null) ? url('book/' . $post->imgart . '') : url('OSK.jpeg')}}"
                                                alt="لاتوجد صورة">
                                        <div
                                ...
                                <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                                    <span href="#"
                                        ...
                                        <span class="mx-2"> {{ date('Y-m-d', strtotime($post->created_at)) }} mins
                                            ago</span>
                                    </span>
                                    <span href="#"
                                        class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
